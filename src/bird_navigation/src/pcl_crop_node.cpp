...
private:
    void processPointCloud(const PointCloud2::SharedPtr msg) {
        ...
        crop_box_filter.setMin(Eigen::Vector4f(-2.0, -1.0, -1.0, 1.0)); // Define the min bounds
        crop_box_filter.setMax(Eigen::Vector4f(2.0, 1.0, 1.0, 1.0));   // Define the max bounds
